...
void Timer0ACapture_init(void)
{
    SYSCTL->RCGCTIMER |= 0x1;     /* enable clock to Timer Block 0; please refer to page 339 of the datasheet*/
    SYSCTL->RCGCGPIO |=0x2;      /* enable clock to PORTB; please refer to page 349 of the datasheet*/
    ...
    GPIOA->DEN |= (1 << 4);         /* Make PA4 a digital pin */
